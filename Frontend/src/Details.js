    ...
    <div>
      ...
      <div className=' boxx d-flex  '>
        ...
        <h4 className="mt-2">Overview of {medicine.name}</h4>
          ...
          <p>Consult the doctor if any of these side effects persist or become bothersome. Though {medicine.name} is essentially safe, it may not suit everyone. Before taking this medicine, let the doctor know if you have any liver or kidney problems, are allergic to it, or are taking other medications as this might affect the dose or suitability of the medicine. In general, take the lowest dose that works for the shortest possible time. It is also the first choice of painkillers during pregnancy or breastfeeding.</p>
          </div>
